...
class ConfigFdbRxVlanTableEntryTest : public BasicTest {
 public:
  ConfigFdbRxVlanTableEntryTest() {}
  virtual ~ConfigFdbRxVlanTableEntryTest() = default;
...
TEST_F(ConfigFdbRxVlanTableEntryTest, configFdbRxVlanEntryFailure) {
