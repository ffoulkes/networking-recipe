...
class ConfigFdbTunnelTableEntryTest : public BaseMacLearnInfoTest {
 public:
  ConfigFdbTunnelTableEntryTest() {}
  virtual ~ConfigFdbTunnelTableEntryTest() = default;
...
TEST_F(ConfigFdbTunnelTableEntryTest, configFdbTunnelEntryFailure) {
...
TEST_F(ConfigFdbTunnelTableEntryTest, configFdbTunnelEntrySuccess) {
  struct mac_learning_info learn_info = {0};
  InitLearnInfo(learn_info);
  InitV4NativeTagged(learn_info);
  learn_info.tnl_info.tunnel_type = OVS_TUNNEL_VXLAN;
