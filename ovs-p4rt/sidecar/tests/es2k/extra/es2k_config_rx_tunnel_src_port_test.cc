...
// Unit test for DoConfigRxTunnelSrcEntry (es2k).
...
class Es2kConfigRxTunnelSrcPortTest : public ::testing::Test {
 protected:
  Es2kConfigRxTunnelSrcPortTest() {}
  ~Es2kConfigRxTunnelSrcPortTest() = default;
 ...
 */
TEST_F(Es2kConfigRxTunnelSrcPortTest, connectFailure) {
 ...
 */
TEST_F(Es2kConfigRxTunnelSrcPortTest, getPipelineConfigFailure) {
...
/**
 * Exercises IPv4 tunnel error path.
 */
TEST_F(Es2kConfigRxTunnelSrcPortTest, configIpv4RxTunnelPortFailure) {
  constexpr char ERROR_MESSAGE[] = "sendRequest";
  struct tunnel_info tunnel_info = {0};
...
/**
 * Exercises IPv4 tunnel happy path.
 */
TEST_F(Es2kConfigRxTunnelSrcPortTest, configIpv4RxTunnelPortSuccess) {
  struct tunnel_info tunnel_info = {0};
  InitIpv4TunnelInfo(tunnel_info);
...
/**
 * Exercises IPv6 tunnel happy path.
 */
TEST_F(Es2kConfigRxTunnelSrcPortTest, configIpv6RxTunnelPortSuccess) {
  struct tunnel_info tunnel_info = {0};
  InitIpv6TunnelInfo(tunnel_info);
